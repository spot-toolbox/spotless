function [G,h]=ltid_vwat2Gh(v,w,a,t,o)
% function [G,h]=ltid_vwat2Gh(v,w,a,t,o)
%
% given passive freq. response data v,w, and Re fitting denominator a,
% get passive fit  G+H; 
% G(z)=C(zI-A)^{-1}B+D is stable and passive (poles defined by a)
% H(z)=sum_i reshape(h(i,:),k,k)*(z^2-1)/(z^2-2*cos(t(i))*z+1)
%
% INPUTS:
...
%
% OUTPUTS: 
%    G:   k-by-k stable passive DT SS model
%    h:   r-by-N 
